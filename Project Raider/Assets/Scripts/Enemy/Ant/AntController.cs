...
public class AntController : MonoBehaviour
{
    ...
    [SerializeField] private bool isFliping;
    ...
    void Start()
    {
        ...
        normalTransform = gameObject.transform;
        nextTransform = gameObject.transform;
    }
    ...
    void Update()
    {
        ...
        if((gameObject.transform.position.x - nextPos.x) < 0.2f && !isFliping){
            animator.SetBool("isWalking", false);
        
        } else if((gameObject.transform.position.x - nextPos.x) > -0.2f && isFliping){
            animator.SetBool("isWalking", false);    
